...
class info():
    def __init__(self):
    	self.mode = 'fullmatchtv_rugby'
        self.name = 'fullmatchtv.com Rugby'
...
class main():
	...
	def __init__(self,url = 'http://fullmatchtv.com/rugby'):
	...
	def get_post(self):
		content = client.request('http://fullmatchtv.com/rugby',referer=self.base)
